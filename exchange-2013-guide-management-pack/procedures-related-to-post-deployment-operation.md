...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dn198286(v=EXCHG.150)
ms:contentKeyID: 54651611
ms.date: 01/09/2015
...
![Désactivation d'alertes dans la console SCOM](images/Dn198286.1c4f15b5-4978-4442-b26b-cc65ba577c9c(EXCHG.150).png "Désactivation d'alertes dans la console SCOM")
...
See the following topics for more information about the cmdlets you can use to configure monitoring overrides.
  ...
  - [Get-MonitoringItemIdentity](https://technet.microsoft.com/fr-fr/library/jj218668\(v=exchg.150\))
