---
title: 'Rôle des copies de base de données: Exchange 2013 Help'
TOCTitle: Rôle des copies de base de données
ms:assetid: 71a95f5b-1f75-4ae9-9ee9-515c3a19d394
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876905(v=EXCHG.150)
ms:contentKeyID: 50478434
ms.date: 05/23/2018
...
Le rôle de gestion `Database Copies` permet aux administrateurs d’ajouter, de supprimer, d’arrêter, de récupérer, d’afficher et de mettre à jour les copies de base de données sur des serveurs individuels.
...
Pour utiliser les cmdlets **Set-MailboxDatabaseCopy** et **Remove-MailboxDatabaseCopy**, incluses dans ce rôle, la base de données que vous souhaitez configurer doit se trouver dans l’étendue de la base de données, et celle-ci doit résider sur un serveur situé dans l’étendue du serveur. Pour plus d’informations sur les étendues, voir [Présentation des portées du rôle de gestion](understanding-management-role-scopes-exchange-2013-help.md).
