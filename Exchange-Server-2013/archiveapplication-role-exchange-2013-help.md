---
title: 'Rôle ArchiveApplication: Exchange 2013 Help'
TOCTitle: Rôle ArchiveApplication
ms:assetid: 22d673cf-d3a3-43f0-be1e-e4fc74546e64
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ673046(v=EXCHG.150)
ms:contentKeyID: 50477642
ms.date: 05/23/2018
...
Le rôle de gestion `ArchiveApplication` permet à des applications partenaires d’archiver des éléments dans les boîtes aux lettres des utilisateurs.
