---
title: 'Rôle des files d’attente de transport: Exchange 2013 Help'
TOCTitle: Rôle des files d’attente de transport
ms:assetid: f663005a-4cb0-4c52-9c95-58681fc5eaab
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876955(v=EXCHG.150)
ms:contentKeyID: 50479578
ms.date: 05/23/2018
...
Le rôle de gestion `Transport Queues` permet aux administrateurs de gérer les files d'attente sur un serveur de transport.
