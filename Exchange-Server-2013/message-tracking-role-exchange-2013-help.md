---
title: 'Rôle de suivi des messages: Exchange 2013 Help'
TOCTitle: Rôle de suivi des messages
ms:assetid: 21f18ccd-9b7d-461b-b77c-443d15696d79
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876858(v=EXCHG.150)
ms:contentKeyID: 50477756
ms.date: 05/23/2018
...
Le rôle de gestion de `Message Tracking` permet aux administrateurs d’effectuer le suivi des messages dans une organisation.
