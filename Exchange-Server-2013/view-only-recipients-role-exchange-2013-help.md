---
title: 'Rôle Destinataires en affichage uniquement: Exchange 2013 Help'
TOCTitle: Rôle Destinataires en affichage uniquement
ms:assetid: 37e66b92-81d3-412f-b7a9-e1bb8cbeb468
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876872(v=EXCHG.150)
ms:contentKeyID: 50477907
ms.date: 04/24/2018
...
Ce rôle peut être combiné à des rôles associés au rôle `View-Only Configuration` afin de créer un groupe de rôles qui peut afficher chaque objet dans l’organisation. Pour plus d’informations, voir [Rôle de configuration en affichage seul](view-only-configuration-role-exchange-2013-help.md).
