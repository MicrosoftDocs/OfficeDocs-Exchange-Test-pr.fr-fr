---
title: 'Rôle MyTextMessaging: Exchange 2013 Help'
TOCTitle: Rôle MyTextMessaging
ms:assetid: 0e030bdb-8a72-4925-bb77-eaca249c36fc
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Ee633454(v=EXCHG.150)
ms:contentKeyID: 50477503
ms.date: 05/23/2018
...
Le rôle de gestion `MyTextMessaging` permet aux utilisateurs individuels de créer, d’afficher et de modifier leurs paramètres de messagerie texte.
...
<th>Portée d’écriture de configuration</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p>Stratégie d’attribution de rôle par défaut</p>
<p>Pour plus d’informations, voir <a href="understanding-management-role-assignment-policies-exchange-2013-help.md">Présentation des stratégies d’attribution de rôle de gestion</a>.</p></td>
<td><p>X</p></td>
<td><p></p></td>
