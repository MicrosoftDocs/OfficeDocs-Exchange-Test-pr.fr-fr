---
title: 'Rôle OfficeExtensionApplication: Exchange 2013 Help'
TOCTitle: Rôle OfficeExtensionApplication
ms:assetid: a78f69b8-2403-40a0-8c86-7e0fb7b10d29
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ657479(v=EXCHG.150)
ms:contentKeyID: 50478835
ms.date: 05/23/2018
...
Le rôle de gestion `OfficeExtensionApplication` permet aux applications partenaires à agir au nom des utilisateurs finaux.
