---
title: 'Rôle Connecteurs d’envoi: Exchange 2013 Help'
TOCTitle: Rôle Connecteurs d’envoi
ms:assetid: 8021e279-2b74-469e-aa6d-d0197f34ba6c
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876913(v=EXCHG.150)
ms:contentKeyID: 50478575
ms.date: 05/23/2018
...
Le rôle de gestion `Send Connectors` permet aux administrateurs de gérer les connecteurs d’envoi de transport dans une organisation.
