---
title: 'Rôle des agents de transport: Exchange 2013 Help'
TOCTitle: Rôle des agents de transport
ms:assetid: 1679402e-158f-4630-8ef1-01ab5c7ce811
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876853(v=EXCHG.150)
ms:contentKeyID: 50477671
ms.date: 05/23/2018
...
Le rôle de gestion `Transport Agents` permet aux administrateurs de gérer les agents de transport d'une organisation.
