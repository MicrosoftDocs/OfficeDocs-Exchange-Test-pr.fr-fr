---
title: 'Rôle des connecteurs de réception: Exchange 2013 Help'
TOCTitle: Rôle des connecteurs de réception
ms:assetid: a7c5a086-5066-4ece-9b22-cc1048d2f2bc
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876927(v=EXCHG.150)
ms:contentKeyID: 50478839
ms.date: 05/23/2018
...
Le rôle de gestion `Receive Connectors` permet aux administrateurs de gérer la configuration des connecteurs de réception, comme les limites de taille d’un serveur.
