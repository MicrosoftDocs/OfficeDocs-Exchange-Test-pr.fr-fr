---
title: 'Rôle des groupes de distribution: Exchange 2013 Help'
TOCTitle: Rôle des groupes de distribution
ms:assetid: 0c3667b6-529b-4bb2-85bf-e24fae82d082
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876848(v=EXCHG.150)
ms:contentKeyID: 50477495
ms.date: 04/24/2018
...
Le rôle de gestion `Distribution Groups` permet aux administrateurs de créer, modifier, afficher et supprimer des groupes de distribution et d’ajouter ou de supprimer les membres des groupes de distribution dans une organisation.
