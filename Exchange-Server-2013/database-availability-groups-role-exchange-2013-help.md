---
title: 'Rôle des groupes de disponibilité de base de données: Exchange 2013 Help'
TOCTitle: Rôle des groupes de disponibilité de base de données
ms:assetid: 0b3e0f7a-21e5-4209-8d5b-b63c6b9de3cc
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876847(v=EXCHG.150)
ms:contentKeyID: 50477527
ms.date: 05/23/2018
