---
title: 'Rôle de gestion de la rétention: Exchange 2013 Help'
TOCTitle: Rôle de gestion de la rétention
ms:assetid: ef16b495-c424-4ded-b5da-304e69ce31bb
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876953(v=EXCHG.150)
ms:contentKeyID: 50479528
ms.date: 05/23/2018
...
Le rôle de gestion `Retention Management` permet aux administrateurs de gérer les stratégies de rétention d'une organisation.
