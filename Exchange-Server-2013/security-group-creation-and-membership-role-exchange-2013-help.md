---
title: 'Création du groupe de sécurité et rôle de membre: Exchange 2013 Help'
TOCTitle: Création du groupe de sécurité et rôle de membre
ms:assetid: 257eb517-339f-4895-9e08-f772408a41cf
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876860(v=EXCHG.150)
ms:contentKeyID: 50477675
ms.date: 04/24/2018
...
Le rôle de gestion `Security Group Creation and Membership` permet aux administrateurs de créer et de gérer des groupes de sécurité universels et leur appartenance à l’organisation.
...
Pour plus d’informations, voir [Présentation des autorisations fractionnées](understanding-split-permissions-exchange-2013-help.md).
