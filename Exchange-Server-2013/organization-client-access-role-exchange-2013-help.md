---
title: 'Rôle d’accès au client de l’organisation: Exchange 2013 Help'
TOCTitle: Rôle d’accès au client de l’organisation
ms:assetid: ff84799a-b79c-498d-b797-7675a4afb1eb
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876962(v=EXCHG.150)
ms:contentKeyID: 50479655
ms.date: 05/23/2018
...
Le rôle de gestion `Organization Client Access` permet aux administrateurs de gérer les paramètres de serveur d’accès au client au sein d'une organisation.
