---
title: 'Rôle de journalisation: Exchange 2013 Help'
TOCTitle: Rôle de journalisation
ms:assetid: 64608dbe-d4b4-444e-a7df-bc536c4da202
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876894(v=EXCHG.150)
ms:contentKeyID: 50478285
ms.date: 05/23/2018
...
Le rôle de gestion `Journaling` permet aux administrateurs de créer, de modifier, d'activer, de désactiver, d'afficher et de supprimer des règles de journal dans une organisation.
