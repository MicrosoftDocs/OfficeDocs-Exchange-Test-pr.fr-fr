---
title: 'Rôle de recherche de boîte aux lettres: Exchange 2013 Help'
TOCTitle: Rôle de recherche de boîte aux lettres
ms:assetid: f86b63ba-0c67-4748-8965-0c08a6a8aec1
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876958(v=EXCHG.150)
ms:contentKeyID: 50479588
ms.date: 05/23/2018
...
Le rôle de gestion `Mailbox Search` permet aux administrateurs de rechercher du contenu dans une ou plusieurs boîtes aux lettres d'une organisation.
