---
title: 'Rôle Journaux d’audit: Exchange 2013 Help'
TOCTitle: Rôle Journaux d’audit
ms:assetid: 36a7d375-76f8-441c-9da1-8a50dbd062f1
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876870(v=EXCHG.150)
ms:contentKeyID: 50477878
ms.date: 04/24/2018
...
Le rôle de gestion `Audit Logs` permet aux administrateurs de configurer le journal d’audit de l’administrateur d’une organisation.
