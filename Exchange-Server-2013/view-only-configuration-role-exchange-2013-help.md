---
title: 'Rôle de configuration en affichage seul: Exchange 2013 Help'
TOCTitle: Rôle de configuration en affichage seul
ms:assetid: 72607063-7f2d-4b3e-a2a9-27eb88e1e16a
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876907(v=EXCHG.150)
ms:contentKeyID: 50478445
ms.date: 05/23/2018
...
Vous pouvez associer ce rôle à ceux liés au rôle `View-Only Recipients` pour créer un groupe de rôles pouvant afficher chaque objet dans une organisation. Pour plus d’informations, voir [Rôle Destinataires en affichage uniquement](view-only-recipients-role-exchange-2013-help.md).
