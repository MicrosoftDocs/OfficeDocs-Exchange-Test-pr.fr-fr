---
title: 'Rôle MyProfileInformation: Exchange 2013 Help'
TOCTitle: Rôle MyProfileInformation
ms:assetid: 309c3a88-8abe-497d-aa92-30bdc58b9eae
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876865(v=EXCHG.150)
ms:contentKeyID: 50477804
ms.date: 05/23/2018
...
Le rôle de gestion `MyProfileInformation` permet aux utilisateurs individuels de modifier leur nom.
