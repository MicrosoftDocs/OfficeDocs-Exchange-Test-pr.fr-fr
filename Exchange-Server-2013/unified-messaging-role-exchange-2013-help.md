---
title: 'Rôle de messagerie unifiée: Exchange 2013 Help'
TOCTitle: Rôle de messagerie unifiée
ms:assetid: bf24aa04-5843-4cf3-83e7-3a5fa7bd3522
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876935(v=EXCHG.150)
ms:contentKeyID: 50479068
ms.date: 05/23/2018
...
Le rôle `Unified Messaging` permet aux administrateurs de gérer les services de messagerie unifiée d’une organisation.

Ce rôle ne vous permet pas de gérer une configuration de boîte aux lettres spécifique à la messagerie unifiée ou des invites de messagerie unifiée. Pour gérer la configuration d'une boîte aux lettres de messagerie unifiée spécifique, utilisez les rôles associés au rôle `UM Mailboxes `. Pour gérer les invites de messagerie unifiée, utilisez les rôles associés au rôle de `UM Prompts`. Pour plus d'informations, voir :
