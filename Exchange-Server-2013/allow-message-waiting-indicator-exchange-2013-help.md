...
Pour plus d'informations sur la gestion des paramètres de l'indicateur de message en attente, consultez les rubriques suivantes :
  ...
  - [Gestion d'une passerelle IP de messagerie unifiée](https://docs.microsoft.com/fr-fr/exchange/voice-mail-unified-messaging/connect-voice-mail-system/manage-um-ip-gateway)

  - [Autoriser les messages en attente indicateur (MWI) sur une passerelle IP de messagerie unifiée](https://docs.microsoft.com/fr-fr/exchange/voice-mail-unified-messaging/set-up-client-voice-mail-features/allow-mwi-on-um-ip-gateway)
