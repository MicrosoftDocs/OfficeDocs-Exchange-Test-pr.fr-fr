---
title: 'Rôle des serveurs Exchange: Exchange 2013 Help'
TOCTitle: Rôle des serveurs Exchange
ms:assetid: 5a626746-8d23-409c-a604-7e565c429990
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876887(v=EXCHG.150)
ms:contentKeyID: 50478163
ms.date: 04/24/2018
...
Le rôle de gestion de `Exchange Servers` permet aux administrateurs d’effectuer les opérations suivantes sur des serveurs individuels :

  - Ajouter et supprimer des groupes de disponibilité de base de données et configurer des copies de base de données

  - Activer, désactiver et configurer des services de messagerie unifiée

  - Modifier la configuration de transport sur les serveurs de boîtes aux lettres et d'accès au Client

  - activer et désactiver Microsoft Outlook Anywhere sur les serveurs d’accès au client

  - Modifier la configuration de serveur de boîtes aux lettres et d'accès au Client

  - modifier la configuration d’Outlook Anywhere sur les serveurs d’accès au client

  - Modifier la configuration de filtrage des serveurs de boîtes aux lettres

  - modifier la configuration du serveur général Exchange

  - Modifier la configuration de l'analyse du serveur

  - afficher la configuration de chaque rôle de serveur
