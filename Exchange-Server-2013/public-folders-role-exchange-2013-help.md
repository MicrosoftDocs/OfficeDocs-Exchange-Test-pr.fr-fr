---
title: 'Rôle Dossiers publics: Exchange 2013 Help'
TOCTitle: Rôle Dossiers publics
ms:assetid: b858f04c-ac0b-495f-9193-8b9645781f73
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876930(v=EXCHG.150)
ms:contentKeyID: 50478924
ms.date: 05/23/2018
...
Le rôle de gestion `Public Folders ` permet aux administrateurs de gérer des dossiers publics dans une organisation.

Ce rôle ne vous permet pas de gérer l’attribution d’une extension messagerie aux dossiers publics. Pour activer ou désactiver l'extension messagerie d'un dossier public, vous devez disposer d'un rôle associé au rôle `Mail Enabled Public Folders `. Pour plus d’informations, voir [Rôle des dossiers publics à extension messagerie](mail-enabled-public-folders-role-exchange-2013-help.md).
