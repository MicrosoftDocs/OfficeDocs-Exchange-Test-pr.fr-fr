---
title: 'Rôle des agents d’extension de cmdlet: Exchange 2013 Help'
TOCTitle: Rôle des agents d’extension de cmdlet
ms:assetid: 20f9f7c2-a8e5-468e-b1a8-c87c562a2be7
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876857(v=EXCHG.150)
ms:contentKeyID: 50477632
ms.date: 05/23/2018
...
Le rôle de gestion de `Cmdlet Extension Agents` permet aux administrateurs d’activer, de désactiver et de définir la priorité des agents d’extension de cmdlet dans une organisation.
