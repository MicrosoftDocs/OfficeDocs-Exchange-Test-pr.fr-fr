---
title: 'Rôle MyDiagnostics: Exchange 2013 Help'
TOCTitle: Rôle MyDiagnostics
ms:assetid: 62ba4bdd-6301-4daf-9368-3b393213ec1d
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd979793(v=EXCHG.150)
ms:contentKeyID: 50478324
ms.date: 05/23/2018
...
Le rôle de gestion `MyDiagnostics` permet à chaque utilisateur d’effectuer des diagnostics de base sur leur boîte aux lettres comme, par exemple, la récupération des informations de diagnostics de calendrier.
