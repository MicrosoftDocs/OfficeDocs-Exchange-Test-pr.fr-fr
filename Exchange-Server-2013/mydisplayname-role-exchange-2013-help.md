---
title: 'Rôle de MyDisplayName: Exchange 2013 Help'
TOCTitle: Rôle de MyDisplayName
ms:assetid: d78d0032-29af-476b-82e3-69364ca7f12f
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Ff461938(v=EXCHG.150)
ms:contentKeyID: 50479290
ms.date: 05/23/2018
...
Le rôle de gestion `MyDisplayName` permet aux utilisateurs individuels d’afficher et de modifier leur nom. Il s’agit d’un rôle personnalisé créé à partir du rôle parent [Rôle MyProfileInformation](myprofileinformation-role-exchange-2013-help.md).
