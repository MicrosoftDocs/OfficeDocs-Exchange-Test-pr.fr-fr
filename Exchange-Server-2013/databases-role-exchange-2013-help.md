---
title: 'Rôle des bases de données: Exchange 2013 Help'
TOCTitle: Rôle des bases de données
ms:assetid: 317d9945-668b-448e-963f-f7127b9b3d79
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876868(v=EXCHG.150)
ms:contentKeyID: 50477842
ms.date: 05/23/2018
...
Le rôle de gestion `Databases` permet aux administrateurs de créer, gérer, monter et démonter des bases de données de boîtes aux lettres sur des serveurs individuels.
...
Pour utiliser la cmdlet **Move-DatabasePath**, incluse dans ce rôle, la base de données que vous souhaitez configurer doit se trouver dans l’étendue de la base de données, et celle-ci doit résider sur un serveur situé dans la portée du serveur.

De même, la cmdlet **Remove-MailboxDatabase** (également incluse dans ce rôle), nécessite que la base de données que vous souhaitez supprimer se trouve dans l’étendue de la base de données, ou que celle-ci réside sur un serveur compris dans l’étendue du serveur. Cela signifie que vous contrôlez qui est en droit de supprimer des bases de données de boîtes aux lettres en utilisant des étendues de base de données ou de serveur.
