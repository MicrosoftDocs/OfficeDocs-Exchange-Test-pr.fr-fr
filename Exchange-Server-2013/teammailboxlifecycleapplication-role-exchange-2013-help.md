---
title: 'Rôle TeamMailboxLifecycleApplication: Exchange 2013 Help'
TOCTitle: Rôle TeamMailboxLifecycleApplication
ms:assetid: 3cd2cd6f-65e1-4e66-a017-054060c46fe1
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ673057(v=EXCHG.150)
ms:contentKeyID: 50477921
ms.date: 05/23/2018
...
Le rôle de gestion `TeamMailboxLifecycleApplication` permet aux applications partenaires de mettre à jour les états de cycle de vie de boîtes aux lettres du site.
