---
title: 'Rôle d’hygiène de transport: Exchange 2013 Help'
TOCTitle: Rôle d’hygiène de transport
ms:assetid: 629792e4-7a8f-4447-b031-1c7d7c994b8a
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876893(v=EXCHG.150)
ms:contentKeyID: 50478322
ms.date: 05/23/2018
...
Le rôle de gestion `Transport Hygiene` permet aux administrateurs de gérer les fonctionnalités anti-spam et anti-programme malveillant d'une organisation.
