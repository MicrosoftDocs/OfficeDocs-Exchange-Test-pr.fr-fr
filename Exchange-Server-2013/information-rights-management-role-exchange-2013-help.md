---
title: 'Rôle de gestion des droits relatifs à l’information: Exchange 2013 Help'
TOCTitle: Rôle de gestion des droits relatifs à l’information
ms:assetid: bb40c2ec-1eb8-43d4-af7c-4fa74c7c3ce2
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876934(v=EXCHG.150)
ms:contentKeyID: 50479000
ms.date: 05/23/2018
...
Le rôle de gestion `Information Rights Management` permet aux administrateurs de gérer les fonctionnalités de gestion des droits relatifs à l'information (IRM) d'Exchange dans une organisation.
