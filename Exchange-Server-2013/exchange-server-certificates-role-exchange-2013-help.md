---
title: 'Rôle des certificats d’Exchange Server: Exchange 2013 Help'
TOCTitle: Rôle des certificats d’Exchange Server
ms:assetid: fffec840-6c7d-4958-905e-edc4bc060d52
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876963(v=EXCHG.150)
ms:contentKeyID: 50479657
ms.date: 05/23/2018
...
Le rôle de gestion `Exchange Server Certificates` permet aux administrateurs de créer, importer, exporter et gérer des certificats de serveur Exchange sur des serveurs individuels.
