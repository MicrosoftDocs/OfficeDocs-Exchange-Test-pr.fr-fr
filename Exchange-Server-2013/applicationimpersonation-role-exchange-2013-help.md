---
title: 'Rôle ApplicationImpersonation: Exchange 2013 Help'
TOCTitle: Rôle ApplicationImpersonation
ms:assetid: d6e43a2f-9b1f-463e-8c56-ca38d9127a5a
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd776119(v=EXCHG.150)
ms:contentKeyID: 50479331
ms.date: 04/24/2018
...
_**Dernière rubrique modifiée :** 2016-11-30_

Le rôle de gestion `ApplicationImpersonation` permet aux applications d'assumer l'identité des utilisateurs dans une organisation pour effectuer des tâches pour leur compte.
