---
title: 'Rôle de gestion des rôles: Exchange 2013 Help'
TOCTitle: Rôle de gestion des rôles
ms:assetid: 71d8553c-150d-4306-8de0-89be6efb5e40
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876906(v=EXCHG.150)
ms:contentKeyID: 50478440
ms.date: 05/23/2018
...
Les utilisateurs auxquels ce rôle est attribué peuvent remplacer le groupe de rôles géré par propriété, configurer n’importe quel groupe de rôles et ajouter ou supprimer des membres dans n’importe quel groupe de rôles.
