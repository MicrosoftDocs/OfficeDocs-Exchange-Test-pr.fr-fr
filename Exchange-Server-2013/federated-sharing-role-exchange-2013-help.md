---
title: 'Rôle de partage fédéré: Exchange 2013 Help'
TOCTitle: Rôle de partage fédéré
ms:assetid: 3d81048c-24bf-447d-a1ee-7fb2974a51fd
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876876(v=EXCHG.150)
ms:contentKeyID: 50477969
ms.date: 05/23/2018
...
Le rôle de gestion `Federated Sharing` permet aux administrateurs de gérer le partage entre des forêts et des organisations dans une organisation.
