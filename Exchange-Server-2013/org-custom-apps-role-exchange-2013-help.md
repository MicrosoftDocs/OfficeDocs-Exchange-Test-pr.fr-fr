---
title: 'Rôle Org Custom Apps: Exchange 2013 Help'
TOCTitle: Rôle Org Custom Apps
ms:assetid: ab2aac13-f783-43e6-a369-75cce1d4943f
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ657482(v=EXCHG.150)
ms:contentKeyID: 50478979
ms.date: 05/23/2018
...
Le rôle de gestion Org Custom Apps permet aux administrateurs d'afficher et de modifier les applications de leur organisation et d'ajouter des applications personnalisées à partir d'un fichier ou d'une URL.
