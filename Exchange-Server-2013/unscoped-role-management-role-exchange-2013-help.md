---
title: 'Rôle de gestion de rôle non délimité: Exchange 2013 Help'
TOCTitle: Rôle de gestion de rôle non délimité
ms:assetid: d11eb843-64c9-4968-bfd5-9a8d94903058
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876943(v=EXCHG.150)
ms:contentKeyID: 50479282
ms.date: 05/23/2018
...
Le rôle de gestion `Unscoped Role Management` permet aux administrateurs de créer et de gérer des rôles de gestion de niveau supérieur et sans portée dans une organisation.
