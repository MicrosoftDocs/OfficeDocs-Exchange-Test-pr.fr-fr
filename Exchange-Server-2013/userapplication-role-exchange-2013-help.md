---
title: 'Rôle UserApplication: Exchange 2013 Help'
TOCTitle: Rôle UserApplication
ms:assetid: a4621e45-53db-42f7-a5d7-c1900a154b4e
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ657476(v=EXCHG.150)
ms:contentKeyID: 50478944
ms.date: 05/23/2018
...
Le rôle de gestion `UserApplication` permet aux applications partenaires d'agir au nom des utilisateurs finaux.
