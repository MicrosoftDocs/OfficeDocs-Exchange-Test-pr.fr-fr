---
title: 'Rôle de configuration de l’organisation: Exchange 2013 Help'
TOCTitle: Rôle de configuration de l’organisation
ms:assetid: db952cc5-ef70-4366-acbb-0e292d4cbdd0
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876946(v=EXCHG.150)
ms:contentKeyID: 50479369
ms.date: 05/23/2018
...
Le rôle de gestion `Organization Configuration` permet aux administrateurs de gérer les paramètres à l'échelle de l'organisation. Ce rôle permet de contrôler, entre autres, les paramètres de configuration suivants pour l'organisation :

  - Activation ou désactivation de la fonctionnalité Infos-courrier pour l'organisation

  - URL de la page d'accueil du dossier géré

  - Adresses de messagerie de secours et adresse SMTP du destinataire Microsoft Exchange

  - Configuration du schéma de propriété de la boîte aux lettres de ressources

  - URL de l’aide du Centre d’administration Exchange et de Microsoft Office Outlook Web App

Ce type de rôle n'inclut pas les autorisations comprises dans les types de rôles `Organization Client Access` ou `Organization Transport Settings`.
