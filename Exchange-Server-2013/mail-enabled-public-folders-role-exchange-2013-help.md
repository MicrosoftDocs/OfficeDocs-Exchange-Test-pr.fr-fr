---
title: 'Rôle des dossiers publics à extension messagerie: Exchange 2013 Help'
TOCTitle: Rôle des dossiers publics à extension messagerie
ms:assetid: 22289ae1-f9e8-4c98-aaad-ee623e05eadd
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876859(v=EXCHG.150)
ms:contentKeyID: 50477638
ms.date: 05/23/2018
...
Le rôle de gestion des `Mail Enabled Public Folders` permet aux administrateurs de configurer les dossiers publics individuels avec ou sans extension de messagerie dans une organisation.

Ce rôle vous permet de gérer uniquement les propriétés de messagerie des dossiers publics. Il ne vous permet pas de gérer les propriétés de dossier public qui ne sont pas liées à la messagerie. Pour gérer les propriétés de dossier public qui ne sont pas liées à la messagerie, utilisez le rôle `Public Folders`. Pour plus d’informations, voir [Rôle Dossiers publics](public-folders-role-exchange-2013-help.md).
