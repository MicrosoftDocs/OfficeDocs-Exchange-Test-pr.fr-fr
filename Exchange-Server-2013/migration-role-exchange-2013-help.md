---
title: 'Rôle de migration: Exchange 2013 Help'
TOCTitle: Rôle de migration
ms:assetid: 8b5a3385-7dc0-4492-9f00-a4616982016b
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd876920(v=EXCHG.150)
ms:contentKeyID: 50478654
ms.date: 04/24/2018
...
Le rôle de gestion `Migration` permet aux administrateurs de procéder à la migration de boîtes aux lettres et de leur contenu vers un serveur ou en provenance d’un serveur.
