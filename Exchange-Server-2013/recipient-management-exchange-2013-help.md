---
title: 'Gestion des destinataires: Exchange 2013 Help'
TOCTitle: Gestion des destinataires
ms:assetid: 669d602e-68e3-41f9-a455-b942d212d130
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dd298028(v=EXCHG.150)
ms:contentKeyID: 50478332
ms.date: 04/24/2018
...
Si la création des principaux de sécurité au sein de votre organisation, tels que les comptes d’utilisateurs, est contrôlée par un groupe spécifique autre que celui des administrateurs Exchange, vous pouvez créer un groupe de rôles et déplacer les rôles Création du destinataire de messagerie et Création du groupe de sécurité et appartenance dans le nouveau groupe de rôles. En effectuant cette opération, vous empêchez les membres du groupe de rôles Gestion des destinataires de créer des objets Active Directory. Ils peuvent cependant continuer à attribuer une extension messagerie aux nouveaux objets Active Directory. Pour plus d’informations sur les autorisations de partage, voir [Présentation des autorisations fractionnées](understanding-split-permissions-exchange-2013-help.md).
